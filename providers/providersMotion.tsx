...
interface ProvidersMotionProps {
    children: ReactNode;
}

const ProvidersMotion = ({ children }: ProvidersMotionProps) => {
    const screenControls = useAnimationControls();
    const scribbleControls = useAnimationControls();
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <motion.path
                        className="transition-scribble-path"
...
export default ProvidersMotion;